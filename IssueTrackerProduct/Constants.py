...
DEFAULT_ENCODE_EMAILDISPLAY = False
...
DEFAULT_SHOW_ID_WITH_TITLE = True
...
DEFAULT_USE_TELLAFRIEND = False
DEFAULT_USE_TELLAFRIEND_FOR_ANONYMOUS = False
...
USE_ISSUENOTES_COOKIEKEY = '__issuetracker_use_issuenotes'
